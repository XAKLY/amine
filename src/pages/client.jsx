  ...
  return (
    <div className="flex flex-col p-4">
      ...
      <div className="mb-0 items-center border-l-4 border-blue-500 pl-4">
        <h1 className="text-3xl font-bold text-gray-800 font-nunito">Client</h1>
        <h2 className="text-lg text-gray-600 font-nunito">Soumission &gt; Client</h2>
      </div>
              ...
              <ul className="absolute bg-white border rounded shadow-lg mt-2 z-10">
                {['Home', 'Client', 'Fournisseurs et sous-traitants', 'Estimations et budgets'].map((item) => (
                  ...
                  <Link
                    ...
                    className={`block px-4 py-2 text-gray-600 hover:bg-blue-500 hover:text-white ${item === 'Client' ? 'font-bold' : ''}`}
      ...
      <div className="w-full p-2">
          ...
          <TableDemo addButton={false}  addClient={true}/>
